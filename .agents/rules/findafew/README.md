...
description: Use to select the narrow Findafew frontend playbook for API/query, forms, routing, realtime/PWA, UI quality, copy, or debugging work.
---

# Findafew frontend rules
...
- `realtime-pwa.md` — Socket.IO, service workers, push, offline, badges, and
  resume refresh.
- `ui-quality-gate.md` — Findafew hierarchy, spacing, responsive behavior,

...
description: "Use when Findafew form work connects React Hook Form, Zod schemas, DTO mapping, backend commands, offline guards, TanStack Query mutations, cache updates, navigation, or user-visible root/field errors."
---

# Findafew Forms: Integration Playbook

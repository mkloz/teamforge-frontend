...
description: "Use when writing or reviewing Findafew user-facing copy, aria labels, toasts, empty states, CTAs, onboarding/results text, errors, notifications, settings labels, or identifiers where dating-app, gamification, or algorithm-language drift is possible."
---

# Findafew Copy Guardrails: Review Playbook
...
- Prefer `group`, `people`, `fit`, `compatible`, `trust`, `plan`, `activity`, `invite`, `conversation`, and `Start a plan`.
...
- Emoji picker metadata may include heart/love words because it describes Unicode emoji; do not treat that as product positioning unless the UI turns hearts into a Findafew action pattern.

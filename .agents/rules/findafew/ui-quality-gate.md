...
description: "Use for Findafew frontend UI implementation, visual review, accessibility review, responsive layout checks, polish, complete loading/error/empty/success states, and rendered verification decisions."
---

# Findafew UI Quality Gate
...
This rule adapts `frontend-product-ui-engineer` and `accessibility-a11y` for Findafew.
...
- Findafew playbooks for API/query, forms, router/guards, realtime/PWA, and copy.

Generic design skills are inspiration only. They do not override Findafew tokens, copy constraints, route ownership, or architecture.
...
Forms should follow `.agents/rules/findafew/forms-rhf-zod-query.md`.

...
export const scenarioCatalog = [
  ...
  scenario(
    ...
    "Authentication",
    "/auth/register",
    "The signed-out account creation form.",
    [],
    "signed-out",
  ),
  scenario(
    ...
    "Authentication",
    "/auth/forgot-password",
    "The signed-out password recovery request form.",
    [],
    "signed-out",
  ),
  scenario(
    ...
    "Authentication",
    "/auth/reset-password/scenario-reset-token",
    "A valid password reset link ready for a new password.",
    [],
    "signed-out",
  ),
  scenario(
    "auth-activation-loading",
    "Authentication · activating account",
    "Authentication",
    "/auth/activate/scenario-activation-token",
    "A valid account activation link while verification is in progress.",
    [],
    "signed-out",
  ),
  scenario(
  ...
  scenario(
    ...
    "Onboarding · personality start",
    "Onboarding",
    "/onboarding/personality",
    "The first-run personality assessment before any answers or result exist.",
  ),
  scenario(
    ...
    "A completed personality assessment opened from Settings.",
  ),
  scenario(
    "onboarding-interests",
    "Onboarding · interests start",
    "Onboarding",
    "/onboarding/interests",
    "The first-run interests experience before any interests are selected.",
  ),
  scenario(
    ...
    "An established member reviewing existing interests from Settings.",
  ),
  scenario(
  ...
  scenario(
    ...
    "Replay the focused Explore, plan creation, and Activity product tour.",
  ),
  scenario(
    ...
    "Onboarding",
    "/plans/new",
    "The plan-first intent enters the real plan builder with one introductory entitlement.",
  ),
  scenario(
  ...
  scenario(
    ...
    "The complete manual plan-creation flow.",
  ),
  scenario(
  ...
  scenario(
    "plan-creation-long-copy",
    "Plan creation · long content",
    "Plan creation",
    "/plans/new?open=true&step=3",
  ...
  scenario(
    "plan-creation-no-recent",
    "Plan creation · no recent items",
    "Plan creation",
    "/plans/new?open=true&step=1",
  ...
  scenario(
    ...
    "Plan creation · group ready",
    "Plan creation",
    "/plans/new?open=true&step=5",
    "Successful group formation with a complete participant roster.",
  ),
  scenario(
    "plan-creation-failed",
    "Plan creation · no group yet",
    "Plan creation",
    "/plans/new?open=true&step=5",
  ...
  scenario(
    "group-proposal-current",
    "Group proposal · review",
    "Group proposals",
    "/group-proposals/scenario-group-proposal-current",
    "A current group proposal with the complete producer response shape.",
    ["group-proposal-current"],
  ),
  ...
  scenario(
    "safety-report-detail",
    "Safety · report detail",
    "Safety",
    "/safety/reports/scenario-report-one",
    "A resolved report with an outcome that can be reviewed.",
  ),
  scenario(
    "safety-account-action-detail",
    "Safety · account action detail",
    "Safety",
    "/safety/account-actions/scenario-enforcement-one",
    "An active account action that can be appealed.",
  ),
  scenario(
    "safety-restriction-detail",
    "Safety · restriction detail",
    "Safety",
    "/safety/restrictions/scenario-containment-one",
    "An active temporary restriction that can be reviewed.",
  ),
  ...
  scenario(
    "admin-moderation-standard",
    "Admin · moderation workspace",
    "Admin",
    "/admin/moderation",
    "A populated human-review moderation queue.",
    [],
    "admin",
  ),
  scenario(
    ...
    "Admin · case detail",
    "Admin",
    "/admin/moderation/cases/scenario-moderation-case-1",
    "A moderation case ready for human review.",
    [],
    "admin",
  ),
  scenario(
    "admin-intake-standard",
    "Admin · intake",
    "Admin",
    "/admin/moderation/intake",
    "A populated moderation intake queue.",
    [],
    "admin",
  ),
  scenario(
  ...
  scenario(
    ...
    "Healthy rollout controls and operational readiness.",
    [],
    "admin",
  ),
  scenario(
    "admin-settings-standard",
    "Admin · policy and rollout",
    "Admin",
    "/admin/moderation/settings",
    "Moderation policy configuration and rollout controls.",
    [],
    "admin",
  ),
  scenario(

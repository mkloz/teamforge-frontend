...
const INSTALL_DEVICE_SWITCH_BUTTON_CLASS =
  "inline-flex min-h-11 items-center rounded-md font-medium text-foreground underline-offset-2 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-foreground focus-visible:ring-offset-2";

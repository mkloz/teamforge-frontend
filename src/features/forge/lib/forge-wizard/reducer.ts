  ...
  switch (action.type) {
    ...
    case "apply-forge-result":
      return {
        ...
        autoForgeRequestId: action.autoForgeRequest?.id ?? null,
        autoForgeRequestRevision: action.autoForgeRequest?.revision ?? null,
        autoForgeRequestLifecycle: action.autoForgeRequest?.lifecycle ?? null,

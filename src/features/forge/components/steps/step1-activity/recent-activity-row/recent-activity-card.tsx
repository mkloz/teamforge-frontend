  ...
  return (
    ...
    >
      ...
      <div className="flex min-w-0 flex-1 items-center gap-2 px-3 py-2.5">
        ...
        {active ? (
          <span className="flex size-6 shrink-0 items-center justify-center rounded-full bg-forge-teal text-white">
  ...
  return (
    <div className="relative flex h-full w-16 shrink-0 items-center justify-center overflow-hidden bg-muted">
      {viewState.hasCoverImage ? (
        ...
        <FallbackIcon
          aria-hidden="true"
          className="size-9 text-muted-foreground/70 transition-colors group-hover:text-forge-teal"
          strokeWidth={1.5}
        />
      )}
    </div>

...
import { ForgeSnapshotFact } from "@/features/forge/components/forge-snapshot-elements";
  ...
  return (
    ...
    >
      ...
      <dl className="mt-5 border-border/35 border-y py-2">
        <ForgeSnapshotFact label="Plan" value={preview.displayPlanTitle} />
        <ForgeSnapshotFact label="Focus" value={preview.displayActivity} />
      </dl>
    </aside>
  );
}

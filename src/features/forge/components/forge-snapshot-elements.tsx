...
export function ForgeSnapshotPoster({
  coverImage,
  eyebrow,
  title,
}: {
...
export function ForgeSnapshotTitleBlock({
  eyebrow,
  title,
}: {
  eyebrow: string | null | undefined;
...
export function ForgeSnapshotFact({
  active = false,
  label,
  value,
}: {
  ...
  return (
    <div
      className={cn(
        ...
        active ? "border-forge-teal" : "border-transparent",
      )}
    >
      <dt
        className={cn(

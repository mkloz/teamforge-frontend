...
export function getProposalScheduleText(proposal: ForgeProposal) {
...
export function getProposalPlaceText(proposal: ForgeProposal) {
...
export function getProposalCostText(proposal: ForgeProposal) {
...
export function getSeatMeta(seat: ForgeProposalSeat) {

    ...
    <section aria-busy="true" className="w-full">
      ...
      <div className="flex w-full flex-col gap-5">
        ...
        <div className="relative grid gap-4 overflow-hidden rounded-xl px-4 py-4 sm:gap-6 sm:px-5 sm:py-5 lg:px-6 2xl:min-h-80 2xl:grid-cols-[minmax(0,1fr)_minmax(17rem,20rem)] 2xl:items-center 2xl:gap-10">
          <div className="absolute inset-y-0 left-0 w-full [background:linear-gradient(112deg,color-mix(in_srgb,var(--color-brand-teal)_13%,transparent),color-mix(in_srgb,var(--color-brand-teal)_4%,transparent)_48%,transparent_76%)]" />
          <div className="absolute inset-y-5 left-2 w-px rounded-full bg-brand-teal/55 sm:inset-y-6 sm:left-3" />

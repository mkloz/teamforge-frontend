...
import type { GroupProposal } from "@/features/group-proposals/public/proposal-review";
import { HomeSectionHeading } from "@/features/home/components/home-section-heading";
import { Button } from "@/shared/components/ui/button";
import { Skeleton } from "@/shared/components/ui/skeleton";
import { StatusPill } from "@/shared/components/ui/status-pill";
import { buildGroupProposalNavigation } from "@/shared/navigation";

interface CurrentGroupProposalStatusProps {
  isError: boolean;
  isLoading: boolean;
  onRetry: () => void;
...
export function CurrentGroupProposalStatus({
  isError,
  isLoading,
  onRetry,
  proposal,
  showTransientState,
}: CurrentGroupProposalStatusProps) {
  if (proposal) {
...
function CurrentProposalSummary({ proposal }: { proposal: GroupProposal }) {
  ...
  return (
    <section
      ...
      aria-labelledby="current-group-proposal-heading"
    >
      <HomeSectionHeading
        id="current-group-proposal-heading"
...
function getProposalView(proposal: GroupProposal) {
  ...
  if (proposal.recovery?.viewerStatus === "ORGANIZER_ACTION") {
    return {
      ...
      navigation: buildGroupProposalNavigation(proposal.id),
    };
  }
...
function getScheduleLabel(proposal: GroupProposal) {

...
import { useGroupProposalRecovery } from "@/features/group-proposals/hooks/use-group-proposal-recovery";
...
interface GroupProposalRecoveryActionsProps {
  proposal: GroupProposal;
  proposalRefreshFailed?: boolean;
}

export function GroupProposalRecoveryActions({
  proposal,
  proposalRefreshFailed = false,
}: GroupProposalRecoveryActionsProps) {
  const navigate = useNavigate();
  const recovery = useGroupProposalRecovery(proposal);
  ...
  useEffect(() => {
    ...
    void navigate({
      ...buildGroupProposalNavigation(recovery.successorProposalId),
      replace: true,
    });
  ...
  return (
    <div className="grid w-full gap-3">
      <p className="text-muted-foreground text-sm leading-relaxed">
        ...
        leave the proposal closed. Findafew will not create a smaller group.
      </p>
    ...
    <section className="grid w-full gap-4" aria-labelledby="recovery-heading">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <ActionDialog
          ...
          description="No one will be added and Findafew will not create a smaller group."

...
import type { GroupProposalReportTargets } from "@/features/group-proposals/schemas/group-proposal-report-targets.schema";
...
export function ProposalHistoricalReportAction({
  ...
  const reportTargetsQuery = useQuery(
    groupProposalQueries.reportTargets(proposalId),
  );
...
function HistoricalTargetPicker({
  ...
  targets: GroupProposalReportTargets["targets"];
}) {

  ...
  return (
    <div className={cn("p-6", isMobile && "pb-safe pb-8")}>
      ...
      <div className="space-y-1">
        <Button
          variant="ghost"
          className="flex items-center gap-3 w-full justify-start h-auto px-3 py-2"
        >
        ...
        <Button
          variant="ghost"
          className="flex items-center gap-3 w-full justify-start h-auto px-3 py-2 hover:bg-red-500/10"
        >

...
/**
 * OceanDiagram - The core radar chart visualization for OCEAN scores.
 * Can be used as a standalone non-interactive diagram or as part of a larger component.
 */
...
function ChartTick(props: ChartTickProps) {
...
/**
 * OceanChart - The full OCEAN visualization component with details and interaction support.
 */

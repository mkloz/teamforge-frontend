    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <button
          type="button"
          className={cn(
            "inline-flex min-h-8 min-w-0 max-w-full cursor-help items-center rounded-full border px-2.5 text-left font-bold text-xs leading-snug focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-forge-teal/35 sm:px-3",
            isSupporting

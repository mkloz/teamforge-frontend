  ...
  return (
    <SettingsProfileForm
      ...
      matching={{
        ...
        groupProposalAvailability: profileFormState.groupProposalAvailability,
        currentUser: profileFormState.currentUser,
      ...
      security={{
        ...
        isConnectingGoogle: profileFormState.isConnectingGoogle,
        ...
        onConnectGoogle: profileFormState.connectGoogle,
        onGoogleConnectionIntent: profileFormState.preloadGoogleConnection,

...
const PEOPLE_PROBLEM_ITEMS = ["one", "two", "three"] as const;
const PLAN_DETAIL_ITEMS = ["activity", "shape", "room"] as const;
const WHY_DIFFERENT_ITEMS = ["plans", "group", "search", "message"] as const;
const GROUP_FEEL_ITEMS = ["interests", "style", "fit", "trust"] as const;
const TRUST_CONTROL_ITEMS = [
  "review",
  "decline",
  "leave",
  "reliability",
...
const THREE_COLUMN_FEATURE_ITEM_CLASS =
  "border-white/10 border-b py-6 last:border-b-0 md:border-r md:border-b-0 md:px-8 last:md:border-r-0 last:md:pr-0 first:md:pl-0";
const FOUR_COLUMN_FEATURE_GRID_CLASS =
  "mt-14 grid border-white/10 border-y md:grid-cols-2 lg:grid-cols-4";
const FOUR_COLUMN_FEATURE_ITEM_CLASS =
  "border-white/10 border-b py-6 last:border-b-0 md:px-6 odd:md:border-r lg:border-r lg:border-b-0 lg:px-7 last:lg:border-r-0 last:lg:pr-0 first:lg:pl-0";
...
function LandingLoadingProgress() {
  return (
...
function LandingHeroLoadingSection() {
  return (
...
function PeopleProblemLoadingSection() {
  return (
...
function PlanToGroupLoadingSection() {
  return (
...
function WhyDifferentLoadingSection() {
  return (
...
function GroupFeelsRightLoadingSection() {
  return (
...
function TrustControlLoadingSection() {
  return (
...
function LandingCtaLoadingSection() {
  return (

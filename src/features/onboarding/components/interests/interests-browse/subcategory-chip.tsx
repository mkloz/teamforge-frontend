...
const subcategoryChipVariants = cva(
  "inline-flex select-none items-center gap-1.5 rounded-full border px-3 py-1.5 font-bold font-sans text-xs leading-none transition duration-150",
  {
    variants: {
      state: {
        collapsed:
          "border-slate-muted/15 bg-card text-slate-muted hover:border-slate-muted/30 hover:bg-canvas dark:border-white/10 dark:hover:border-white/18 dark:hover:bg-white/5",

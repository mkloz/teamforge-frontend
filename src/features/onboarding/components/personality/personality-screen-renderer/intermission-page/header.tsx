    ...
    >
      <div className="relative flex h-16 w-16 shrink-0 items-center justify-center pr-4 sm:h-22 sm:w-22 sm:pr-7">
        ...
        <div className="absolute inset-0 flex items-center justify-center pr-4 sm:pr-7">
          <div className="z-10 flex h-9 w-9 items-center justify-center rounded-xl border border-border bg-card text-forge-teal shadow-lg shadow-forge-teal/5 transition-transform duration-300 group-hover:scale-105 dark:shadow-[0_10px_24px_rgba(0,0,0,0.28)] sm:h-11 sm:w-11 sm:rounded-2xl">
            <Icon size={18} strokeWidth={2.5} className="sm:size-[21px]" />
          </div>
        </div>
      </div>

      <div className="flex h-16 flex-col items-start justify-center border-l border-slate-200/80 pl-4 dark:border-white/10 sm:h-22 sm:pl-7">
        <span className="mb-1 font-sans text-[10px] font-black uppercase tracking-[0.18em] text-forge-teal/80 sm:text-xs">
          Quick Break
        </span>

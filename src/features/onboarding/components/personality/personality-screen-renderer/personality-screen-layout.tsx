  ...
  return (
    <MotionStep className="mb-5 self-start">
      <Button
        ...
        size="sm"
        onClick={onBack}
        className="h-8 rounded-md px-2 text-sm font-bold text-muted-foreground underline-offset-4 hover:bg-transparent hover:text-ink hover:underline focus-visible:ring-forge-teal dark:hover:text-white"
      >

...
export function PlanCreationPageLoading(_props: PageLoadingProps = {}) {
  return (
    <div aria-busy="true">
      <output className="sr-only">Loading the plan builder</output>
      <PlanCreationPageLoadingFixture />
    </div>
  );
}

function PlanCreationPageLoadingFixture() {
  return (
      ...
      <div className="flex flex-col gap-10 py-5 lg:py-10">
        <section className="grid gap-7 border-border border-b pb-8 md:grid-cols-[minmax(0,1fr)_minmax(16rem,25rem)] md:items-end md:pb-10 lg:gap-12">
          ...
          <aside
            ...
            className="overflow-hidden rounded-2xl border border-brand-teal/25 bg-primary-soft"
          >
            <div className="flex items-center justify-between gap-4 border-brand-teal/20 border-b px-4 py-3">
            ...
            <dl className="divide-y divide-brand-teal/15">

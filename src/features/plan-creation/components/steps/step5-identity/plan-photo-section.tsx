...
function getPresetGradient(
  ...
  if (!activePreset) {
    return "from-brand-teal/18 via-canvas to-brand-amber/18";
  }
...
function CoverChoiceButton({
  ...
  return (
    ...
    >
      ...
      {selected ? (
        <span className="absolute top-1.5 right-1.5 grid size-5 place-items-center rounded-full bg-brand-teal text-white shadow-sm">

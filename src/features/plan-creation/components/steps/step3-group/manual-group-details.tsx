...
>) {
  return (
    <div className="grid gap-3 px-0.5 pt-1">
      ...
      <label className="relative block" htmlFor="plan-creation-friend-search">
        ...
        />
        <Input
          id="plan-creation-friend-search"
          type="search"
          value={friendSearch}
...
function CapacityReachedNotice({ show }: { show: boolean }) {
  ...
  return (
    <p className="px-1 font-semibold text-brand-amber text-xs">

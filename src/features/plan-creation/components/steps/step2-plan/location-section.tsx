...
import type { GroupFormationScope, LocationType } from "./types";
...
export function LocationSection({
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="pt-4">
        {groupFormationScope === "LOCAL" && !hasLocalFormationCoordinates ? (
          <LocalCoordinateRequirement
            isChecking={isCheckingLocalFormationCoordinates}
            locationType={locationType}
            onAddLocation={() => onLocationTypeChange("IN_PERSON")}
          />
        ) : null}
...
function LocalCoordinateRequirement({
  isChecking,
  locationType,
  onAddLocation,
}: {
  ...
  return (
    <Notice
      ...
      className="mb-4"
      action={
        !isChecking && locationType !== "IN_PERSON" ? (
          <Button
            type="button"
            variant="outline"
            size="sm"
      ...
      <p>
        {isChecking
          ...
          : locationType === "IN_PERSON"
            ? "Use the location button below to attach private coordinates before starting local group formation."

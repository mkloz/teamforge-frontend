...
export function TemplateSuggestionCard({
  ...
  return (
    ...
    >
      ...
      {active ? (
        <span className="absolute top-2.5 right-2.5 z-10 flex size-7 items-center justify-center rounded-full bg-brand-teal text-white ring-1 ring-white/20">
...
function getTemplateBorderClassName({
  ...
  if (active) {
    return "border-2 border-brand-teal ring-2 ring-brand-teal/25";
  }
  ...
  if (isRecommended) {
    return "border-2 border-brand-amber hover:border-brand-amber";
  }

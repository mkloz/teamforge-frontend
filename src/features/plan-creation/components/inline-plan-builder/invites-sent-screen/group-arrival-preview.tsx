      ...
      >
        {hasCover ? (
          ...
          <div className="absolute inset-0 opacity-70" aria-hidden="true">
            <div className="absolute top-8 right-4 size-32 rounded-full bg-brand-teal/20 blur-3xl" />
            <div className="absolute bottom-4 left-2 size-24 rounded-full bg-brand-amber/14 blur-3xl" />
          </div>
        )}

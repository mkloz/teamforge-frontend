...
export function MobileActionDock({ detail }: MobileActionDockProps) {
  ...
  return (
    <div className="fixed inset-x-0 bottom-app-bottom-nav z-30 border-border/70 border-t bg-canvas/95 px-4 pt-3 pb-3 shadow-[0_-8px_24px_rgb(0_0_0/6%)] backdrop-blur-md lg:hidden">

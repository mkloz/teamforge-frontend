...
export function buildCreateNextPlanPayload(plan: Plan): CreateGroupPlanPayload {
  return {
    ...
    costAmountDecimal: plan.costAmountDecimal,
    costCurrency: plan.costCurrency,
    costAccuracy: plan.costAccuracy,
    costBasis: plan.costBasis,
    depositAmountDecimal: plan.depositAmountDecimal,
    refundPolicy: plan.refundPolicy,
    purchaseResponsibility: plan.purchaseResponsibility,
    costCheckedAt: plan.costCheckedAt,
    costLegacyUnknown: plan.costLegacyUnknown,

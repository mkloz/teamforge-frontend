...
import type { UnifiedMessageItemProps } from "../message-renderer-props";
...
interface MessageItemRenderControllerInput {
  ...
  kind: UnifiedMessageItemProps["kind"];
  message: UnifiedMessage;
  onActivateReplyTarget: UnifiedMessageItemProps["onActivateReplyTarget"];
  onStartSelection: UnifiedMessageItemProps["onStartSelection"];
  onToggleSelected: UnifiedMessageItemProps["onToggleSelected"];
  searchQuery: string;
  showSender: boolean;
}

...
export function GroupCapacityMeter({
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <span className="shrink-0 font-semibold text-slate-muted text-xs">
        Capacity
      </span>
      ...
      <span className="shrink-0 font-bold text-ink text-xs tabular-nums">
        {Math.max(maxMembers - memberCount, 0)} open
      </span>
    </div>
  );
}

...
export const ACTIVITY_MENU_ITEM_CLASS =
  "min-h-8 gap-2 rounded-md px-2 py-1.5 font-bold text-xs focus:bg-primary-soft focus:text-ink data-[highlighted]:bg-primary-soft data-[highlighted]:text-ink";

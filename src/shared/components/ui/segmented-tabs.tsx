      ...
      {options.map((option) => {
        ...
        return (
          <button
            ...
            className={cn(
              "relative isolate inline-flex h-9 min-w-0 items-center justify-center gap-1.5 overflow-hidden rounded-full px-3 font-bold text-xs leading-none outline-none transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-forge-teal/45 focus-visible:ring-offset-1",
              fill && "flex-1",

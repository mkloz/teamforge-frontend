  ...
  "group relative inline-flex min-w-0 cursor-pointer items-center justify-center gap-2 whitespace-nowrap font-bold text-sm transition-all duration-150 ease-out focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-offset-2 focus-visible:ring-offset-background active:scale-95 disabled:pointer-events-none disabled:cursor-not-allowed data-[loading=true]:cursor-wait",
  {
    variants: {
      variant: {
        ...
        accentGhost:
          "border-2 border-transparent bg-transparent text-slate-muted hover:border-primary/25 hover:text-primary focus-visible:ring-primary active:translate-y-px active:border-primary/40 focus-visible:dark:ring-primary",
        inverseGhost:
          "border border-white/18 bg-white/8 text-white/80 hover:border-white/40 hover:text-white focus-visible:ring-white active:translate-y-px active:border-white/55",
        link: "text-primary underline-offset-4 hover:underline focus-visible:ring-primary",
        subtle:
          "border border-transparent bg-muted/40 text-slate-muted hover:border-border hover:text-ink",
      },
      size: {

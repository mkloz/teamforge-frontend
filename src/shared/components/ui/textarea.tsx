  ...
  return (
    <textarea
      ...
      className={cn(
        ...
        "aria-invalid:bg-destructive-soft aria-invalid:ring-1 aria-invalid:ring-destructive/35 focus-visible:aria-invalid:ring-destructive [@media(pointer:coarse)]:text-base!",
        className,
      )}
      {...props}
    />
